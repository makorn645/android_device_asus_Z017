...
int main() {
    ...
    PRINT(ASUS_RESERVED_PARAM_1,    pMetadata);
    ...
    PRINT(ASUS_RESERVED_PARAM_2,    pMetadata);
    PRINT(ASUS_RESERVED_PARAM_3,    pMetadata);
    PRINT(ASUS_RESERVED_PARAM_4,    pMetadata);
    PRINT(ASUS_RESERVED_PARAM_5,    pMetadata);
    PRINT(ASUS_RESERVED_PARAM_6,    pMetadata);
    PRINT(ASUS_RESERVED_PARAM_7,    pMetadata);
    PRINT(ASUS_RESERVED_PARAM_8,    pMetadata);
    PRINT(ASUS_RESERVED_PARAM_9,    pMetadata);
    PRINT(ASUS_RESERVED_PARAM_10,    pMetadata);
    PRINT(ASUS_RESERVED_PARAM_11,    pMetadata);
    PRINT(ASUS_RESERVED_PARAM_12,    pMetadata);
    PRINT(ASUS_RESERVED_PARAM_13,    pMetadata);
    PRINT(ASUS_RESERVED_PARAM_14,    pMetadata);
    PRINT(ASUS_RESERVED_PARAM_15,    pMetadata);
    PRINT(ASUS_RESERVED_PARAM_16,    pMetadata);
    PRINT(ASUS_RESERVED_PARAM_17,    pMetadata);
