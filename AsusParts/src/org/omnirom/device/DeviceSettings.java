...
public class DeviceSettings extends PreferenceFragment implements
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        mProxCheck = (TwoStatePreference) findPreference(KEY_PROX_CHECK);
        mProxCheck.setChecked(PreferenceManager.getDefaultSharedPreferences(getContext()).getBoolean(DeviceSettings.KEY_PROX_CHECK, false));
        mProxCheck.setOnPreferenceChangeListener(this);
